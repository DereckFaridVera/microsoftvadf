...
<div class="container">
    ...
    <a href="/microsoftvadf/app/views/estadocivil/create.php"><button>Agregar</button></a>
            ...
            <?php if (!empty($estadosciviles) && is_array($estadosciviles)): ?>
                <?php foreach ($estadosciviles as $estadocivil): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/microsoftvadf/public/estadocivil/edit?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/microsoftvadf/public/estadocivil/eliminar?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>"
...
<script src="/microsoftvadf/public/js/script.js"></script>
</body>
</html>
