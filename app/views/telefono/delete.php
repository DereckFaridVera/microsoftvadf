...
<div class="page">
    ...
    <div class="glass-card">
        <p class="warning">
            ¿Seguro que deseas eliminar este número?<br><br>
            <strong>"<?= htmlspecialchars($sexo['nombre']) ?>"</strong>
        </p>

        <form action="/microsoftvadf/public/sexo/delete" method="POST">

            <input type="hidden" name="idsexo"
                   value="<?= htmlspecialchars($sexo['idsexo']) ?>">

            <label>Nombre:</label>
            <input type="text" value="<?= htmlspecialchars($sexo['nombre']) ?>" disabled>
